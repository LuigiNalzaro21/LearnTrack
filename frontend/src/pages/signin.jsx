...
const Signin = () => {
    ...
    const handleSignIn = () => {
        ...
        if (email !== 'galars@gmail.com' || password !== 'galars') {
                    ...
                    <form action='' className='p-10'>
                        ...
                        <div className='mb-10'>
                            <button
                                ...
                                className='text-white w-full bg-gray-950 p-3 md:p-4 lg:p-5 rounded-full text-lg md:text-2xl lg:text-3xl hover:bg-gray-800
